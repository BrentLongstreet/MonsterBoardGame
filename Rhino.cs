...
namespace CharacterGen
{
    class Rhino : Monster , IActor
    {
        ...
        public Rhino(int atk, int hp, int def, int lvl, bool hos, string sym, ConsoleColor c = ConsoleColor.Green) : base(atk, hp, def, lvl, hos, sym)
        {
            attack = atk;
            health = hp;
            defense = def;
