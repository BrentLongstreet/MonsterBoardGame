...
namespace CharacterGen
{
    class Boss : Monster, IActor
    {
        ...
        public Boss(int atk, int hp, int def, int lvl, bool hos, string sym, ConsoleColor c = ConsoleColor.White) : base(atk, hp, def, lvl, hos, sym)
        {
            attack = atk;
            health = hp;
            defense = def;
        ...
        public virtual void Interact(Board b, IActor a)
        {
            ...
            Utils.Message("You feel weak! -"+a.defense);
            Utils.Message("Weapon is getting dull! -" + a.attack);
